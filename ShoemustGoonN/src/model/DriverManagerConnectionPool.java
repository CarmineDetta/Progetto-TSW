    ...
    private static final Logger LOGGER = Logger.getLogger(DriverManagerConnectionPool.class.getName());
		...
		public static synchronized Connection getConnection() throws SQLException {
			...
			if (!freeDbConnections.isEmpty()) {
				...
				try { //Controlla se la connessione non ̬ stata aperta con successo 
		...
		//Ogni volta che si smette di utilizzare una connessione la si inserisce nella lista, ̬ una buona pratica!
