...
<html lang="it" xml:lang="it">
	...
	<link href="style/Ordini-utente.css" rel="stylesheet" type="text/css">
...
<div class="content">
	...
	<div class="completo">
		...
		<div class="elements2">
			...
			<button id="stampa"><a href="PDFControl?idOrdine=<%= bean.getID_Ordine()%>" target="_blak">Stampa Fattura</a></button>
	</div>	
